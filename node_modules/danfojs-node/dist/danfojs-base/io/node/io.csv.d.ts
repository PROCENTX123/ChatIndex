 ...
 * ```
 */
declare const $openCsvInputStream: (filePath: string, options: CsvInputOptionsNode) => stream.Readable;
/**
 ...
 * ```
 */
declare const $writeCsvOutputStream: (filePath: string, options: CsvInputOptionsNode) => stream.Writable;
